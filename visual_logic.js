...
registerOnClick('sphere_black', false, false, [0,1,2], function() {
  assignMat('metal stand', 'chrome.001');
}, function() {});
...
registerOnClick('sphere_white', false, false, [0,1,2], function() {
  assignMat('metal stand', 'paint white');
}, function() {});

registerOnClick('slab 1', false, false, [0,1,2], function() {
  replaceTexture('WoodMaterial0', 'wood', './wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('slab 2', false, false, [0,1,2], function() {
  replaceTexture('WoodMaterial0', 'wood', './wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('slab 3', false, false, [0,1,2], function() {
  replaceTexture('WoodMaterial0', 'wood', './wood_basecolor_3.jpg', function() {});
}, function() {});
